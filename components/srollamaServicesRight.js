...
const ScrollamaServiceRight = ({ stepsData, images }) => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'row-reverse', maxWidth: '70rem', margin: '6rem auto', backgroundColor: '#f4f4f4' }}>
      {/* Image Container Wrapper */}
      <div style={{ position: 'sticky', width: '100%', height: '81vh', top: '10vh' }}>
        <img src={currentImage} alt="Step related" style={{ 
            width: '100%', 
            height: '100%', 
            objectFit: 'contain',
...
export default ScrollamaServiceRight;
